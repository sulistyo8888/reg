...
echo "\e[92m| ___\e[93mTELEGRAM\e[92m_:\e[93m@B*diS*l*sty*Angk*dj*j*\e[92m________|\n";
echo "\e[92m| ___\e[93mGITHUB\e[92m___:\e[93mgithub.com/sulistyo8888\e[92m________|\n";
...
// function change(){
        ...
        echo color("green","\n▬▬▬▬▬▬▬▬▬▬▬▬🎫AUTO REDEEM TOD🎫▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("white","🔐▶️ Claim Voucher GOSEND 7K");
	...
	gocar:
        echo "\n".color("white","🔐▶️ Claim VOUCHER GOMART 10K");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        ...
        echo "\n".color("green","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("white","🔐▶️ Claim voc GOFOOD 15K 10K 5K");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(3);
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","🔓▶️ Message: ".$message);
        echo "\n".color("white","🔐▶️ Claim voc GoFood 10K 10K 10K");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(1);
	...
	$post = [
         ...
         echo color("green","▬▬▬▬▬▬▬▬▬▬▬▬▬▬🔧 PIN MU = 888888  ▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"888888"}';
